<%-- 
    Document   : Dashboard
    Created on : May 19, 2017, 1:03:57 PM
    Author     : Fujitsu
--%>
            ...
            <div class="container-fluid">
                <div class="row">
                        ...
                        <div class="card">
                            ...
                            <div class="content">
                                ...
                                <div class="footer">
                                    ...
                                    <hr>
                                    <div class="stats">
                                        <i class="fa fa-clock-o"></i> Campaign sent 2 seconds ago
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Real-time Application Usage</h4>
