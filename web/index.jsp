<%-- 
    Document   : index
    Created on : Apr 4, 2017, 12:05:19 PM
    ...
    <div class="login-html">
        ...
        <div class="login-form">
            ...
            <div class="sign-up-htm">
                ...
                <div class="group">
                    <label for="pass" class="label">SPBT's ID (contact your administrator)</label>
                    <input id="pass" name="spbtid" type="text" class="input" >
                </div>
                <div class="group">
                    <label for="pass" class="label">Email Address (please enter valid email address)</label>
